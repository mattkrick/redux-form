      ...
      var Form = function (_Component) {
        ...
        _createClass(Form, [{
          ...
          value: function shouldComponentUpdate(nextProps) {
            ...
            var _initialConfig$immuta = initialConfig.immutables,
                immutables = _initialConfig$immuta === undefined ? [] : _initialConfig$immuta;
            ...
            return Object.keys(nextProps).some(function (prop) {
              ...
              // }
              return !~propsToNotUpdateFor.indexOf(prop) && !~immutables.indexOf(prop) && !deepEqual(_this3.props[prop], nextProps[prop]);
            });
          }
        }, {
